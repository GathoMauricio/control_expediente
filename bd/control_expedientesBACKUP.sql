...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2017 a las 02:32:36
...
--
-- Base de datos: `control_expedientes`
--
...
INSERT INTO `usuario` (`id_usuario`, `tipo_usu`, `nom_usu`, `con_usu`, `curp`, `nombre_usu`, `ape_pat`, `ape_mat`, `prof`, `sex`, `cedula_p`, `matricula`, `fecha_naci`, `cedula_esp`) VALUES
(1, 'Administrador', 'gatho', 'qwerty', NULL, 'Mauricio', 'Juarez', 'Soriano', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 'Asistente', 'asistente', 'asist', 'JSDHFKFJHFO', 'Nuevo', 'Usuario', 'Asistente', 'Alguna', 'F', 'N/A', '465423', '1995-10-31', 'Test');
...
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
